<x-app-layout>
    ...
    <x-breadcrumb title="Surat Izin Operator" :items="[
    ['label' => 'Data Master', 'url' => route('dashboard')],
    ['label' => 'Surat Izin Operator']
]" />
    ...
    <div class="space-y-6">
        <div class="p-0 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
            <div class="flex justify-between mb-4">
                ...
                <x-button
                href="{{ route('surat-izin-operator.create') }}"
                variant="primary"
                size="base"
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-1">
                                    <x-button
                                    target="_blank"
                                    href="{{ route('surat-izin-operator.show',$item->id) }}"
                                    variant="info"
                                    size="sm"
                                ...
                                <i class="fa-solid fa-eye"></i>
                                    ...
                                    <x-button
                href="{{ route('surat-izin-operator.edit',$item->id) }}"
                variant="warning"
                size="sm"
        ...
        <form id="delete-form" action="{{ route('surat-izin-operator.destroy',$item->id) }}" method="POST">
            @csrf
            @method('DELETE')
