<x-app-layout>
    ...
    <x-breadcrumb title="Genset" :items="[
    ...
    <div class="space-y-6">
        <div class="p-0 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
                ...
                <table class="w-full py-3   text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                {{ $item->nama_pabrik_pembuatan }}
                            </td>
                            <td class="px-6 py-4">
                                {{ $item->tempat_pembuatan }}
                            </td>
                            <td class="px-6 py-4">
                                {{ $item->nomor_pabrik_pembuatan }}
                            </td>
                            <td class="px-6 py-4">
                                {{ $item->daya }}
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-1">
                                    <x-button
                href="{{ route('genset.show',$item->id) }}"
                variant="info"
                size="sm"
            ...
            <i class="fa-solid fa-eye"></i>
                                    ...
                                    <x-button
                href="{{ route('genset.edit',$item->id) }}"
                variant="warning"
                size="sm"
        ...
        <form id="delete-form" action="{{ route('genset.destroy',$item->id) }}" method="POST">
            @csrf
            @method('DELETE')
                                    <x-button
                target="_blank"
