add<x-app-layout>
    ...
    <x-breadcrumb title="Vendor Archive Data" :items="[
    ['label' => 'Archive Data', 'url' => route('dashboard')],
    ['label' => 'Vendor Archive Data']
]" />
    ...
    <div class="space-y-6">
        <div class="p-0 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
            <div class="flex justify-between mb-4">
                ...
                <x-button
                href="{{ route('vendor-archive.create') }}"
                variant="primary"
                size="base"
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-1">
                                    <x-button
                                    href="{{ route('vendor-archive.show',$item->id) }}"
                                    variant="primary"
                                    size="sm"
                                ...
                                <i class="fa-solid fa-eye"></i>
                                    ...
                                    <x-button
                                    target="_blank"
                                    href="{{ route('vendor-archive.qrcode',$item->id) }}"
                                    variant="info"
                                    size="sm"
                                    class="items-center w-max p-0 gap-2"
                                >
                                <i class="fa-solid fa-qrcode"></i>
                                    ...
                                    <x-button
                href="{{ route('vendor-archive.edit',$item->id) }}"
                variant="warning"
                size="sm"
        ...
        <form id="delete-form" action="{{ route('vendor-archive.destroy',$item->id) }}" method="POST">
            @csrf
            @method('DELETE')
