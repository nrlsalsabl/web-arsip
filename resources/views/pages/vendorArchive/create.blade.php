<x-app-layout>
    ...
    <x-breadcrumb title="Tambah Vendor Data Arsip" :items="[
    ...
    <div class="space-y-6">
        <div class="p-0 sm:p-8 sm:pb-12 bg-white shadow sm:rounded-lg dark:bg-gray-800">
            <form enctype="multipart/form-data" action="{{ route('vendor-archive.store') }}" method="POST" class="px-2 py-2">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-5">
                    ...
                    <div class="w-full">
                        ...
                        <x-form.input value="{{ old('company_name') }}" type="text" name="company_name" id="company_name" placeholder="Contoh: Surat, Kontrak" class="w-full" />
