<x-app-layout>
    ...
    ['label' => 'Form Form', 'url' => route('dashboard')],
    ['label' => 'Vendor']
]" />
    ...
    <div class="space-y-6">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-1">
                                    <x-button
                                    target="_blank"
                                    href="{{ route('vendor-form.show',$item->id) }}"
                                    variant="info"
                                    size="sm"
                                ...
                                <i class="fa-solid fa-eye"></i>
                                    ...
                                    <x-button
                href="{{ route('vendor-form.edit',$item->id) }}"
                variant="warning"
                size="sm"
        ...
        <form id="delete-form" action="{{ route('vendor-form.destroy',$item->id) }}" method="POST">
            @csrf
            @method('DELETE')
