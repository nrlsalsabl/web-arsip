<x-app-layout>
    ...
    <x-breadcrumb title="Detail Bejana Tekan" :items="[
        ['label' => 'Bejana Tekan', 'url' => route('bejana-tekan.index')],
        ['label' => 'Detail Bejana Tekan']
    ]" />

    <div class="space-y-6">
        <div class="p-0 sm:p-8 sm:pb-12 bg-white shadow sm:rounded-lg dark:bg-gray-800">
            <div class="relative overflow-x-auto">
                <div action="{{ route('bejana-tekan.update', $bejanaTekan->id) }}" method="POST" class="px-2 py-2">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex justify-between mt-6">
                        <div></div>
                        <x-button
                        href="{{ route('bejana-tekan.edit',$bejanaTekan->id) }}"
                        variant="primary"
                        size="lg"
                    ...
                    >
                        ...
                        <x-button
                        href="{{ route('bejana-tekan.cetak',$bejanaTekan->id) }}"
                        variant="primary"
                        size="lg"
                        class="items-center max-w-xs gap-2"
                    >
