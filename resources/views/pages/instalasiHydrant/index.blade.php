    ...
    <div class="space-y-6">
        <div class="p-0 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
            <div class="flex justify-between mb-4">
                ...
                <x-button
                href="{{ route('instalasi-hydrant.create') }}"
                variant="primary"
                size="base"
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full py-3   text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @forelse ($instalasiHydrants as $item)          
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-1">
                                    <x-button
                                    href="{{ route('instalasi-hydrant.show',$item->id) }}"
                                    variant="info"
                                    size="sm"
                                ...
                                <i class="fa-solid fa-eye"></i>
                                    ...
                                    <x-button
                href="{{ route('instalasi-hydrant.edit',$item->id) }}"
                variant="warning"
                size="sm"
        ...
        <form id="delete-form" action="{{ route('instalasi-hydrant.destroy',$item->id) }}" method="POST">
            @csrf
            @method('DELETE')
                                    <x-button
                target="_blank"
